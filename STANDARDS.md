...
This is an agentic AI course for mining engineering. All code, analysis, and figures follow these rules.

**Agent Compatibility:** This document is designed to work with Claude Code, GitHub Copilot/Codex, and other AI coding assistants. Load this file as context before requesting code generation.
...
- **Document**: Update README.md and STANDARDS.md if conventions change.
